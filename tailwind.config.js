    ...
    plugins: [
        ...
        plugin(function ({ addBase }) {
            addBase({
                // Default colors
                ":root": {
                    "--color-theme-1": toRGB(colors.slate["500"]),
                    "--color-theme-2": toRGB(colors.slate["500"]),
                    "--color-primary": toRGB(colors.slate["500"]),
                    "--color-secondary": toRGB(colors.slate["200"]),
                    "--color-success": toRGB(colors.lime["500"]),
                    "--color-info": toRGB(colors.cyan["500"]),
                    "--color-warning": toRGB(colors.slate["400"]),
                ...
                ".dark": {
                    "--color-primary": toRGB(colors.yellow["500"]),
