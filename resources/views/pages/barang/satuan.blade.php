...
@section('subhead')
    <title>{{ $storeSettings['store_name'] }} - Satuan Barang</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium uppercase">Satuan Barang</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center xl:flex-nowrap">
            ...
            <div class="mt-3 flex w-full items-center xl:mt-0 xl:w-auto">
                <form action="{{ route('barang.satuan') }}" method="GET" class="relative w-56 text-slate-500">
                    <x-base.form-input
                            ...
                            <x-base.table.td @class([
                                ...
                                <div class="flex items-center justify-center">
                                    <a
                                        ...
                                        onclick="openEditModal('{{ route('barang.satuan.update', $satuan->id) }}', '{{ $satuan->satuan }}')"    
                                    >
                                        <x-base.lucide
                                            class="mr-1 h-4 w-4"
                                            icon="CheckSquare"
                                    ...
                                    <a
                                        ...
                                        onclick="openDeleteModal('{{ route('barang.satuan.destroy', $satuan->id) }}')"
                                        href="#"
                                    >
                                        <x-base.lucide
                                            class="mr-1 h-4 w-4"
                        ...
                        <form action="{{ route('barang.satuan.store') }}" method="POST">
                            ...
                            <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                                <div class="col-span-12 sm:col-span-12">
                                    <x-base.form-label for="modal-form-1">Satuan Barang</x-base.form-label>
                                    <x-base.form-input
                                        id="modal-form-1"
                                        type="text"
                                        name="satuan"
    ...
    <!-- END: Tambah Satuan Modal -->

    <!-- BEGIN: Edit Satuan Modal -->
    <x-base.dialog id="edit-barang-modal">
        <x-base.dialog.panel>
            <form id="edit-barang-form" method="POST">
                ...
                @method('PUT')
                <x-base.dialog.title>
                    <h2 class="mr-auto text-base font-medium">Edit Satuan Barang</h2>
                </x-base.dialog.title>

                <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        <x-base.form-label for="edit-modal-form-1">Satuan Barang</x-base.form-label>
                        <x-base.form-input
...
<script>
    function openEditModal(url, satuan) {
        document.getElementById('edit-barang-form').action = url;
        document.getElementById('edit-modal-form-1').value = satuan;
    }
