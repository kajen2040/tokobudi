...
@section('subhead')
    <title>{{ $storeSettings['store_name'] }} - Jenis Barang</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium uppercase">Jenis Barang</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center xl:flex-nowrap">
            ...
            <div class="mt-3 flex w-full items-center xl:mt-0 xl:w-auto">
                <form action="{{ route('barang.jenis') }}" method="GET" class="relative w-56 text-slate-500">
                    <x-base.form-input
