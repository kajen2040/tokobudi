...
@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium uppercase">DISKON</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        ...
        <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
            <x-base.table class="-mt-2 border-separate border-spacing-y-[10px]">
                ...
                <x-base.table.tbody>
                    @php
                        $diskon = ['Khusus Pelanggan', 'Tahun Baru']
                    @endphp
                    @foreach (array_slice($diskon, 0, 2) as $faker)
                ...
                <x-base.dialog id="tambah-barang-modal-preview">
                    <x-base.dialog.panel>
                        ...
                        <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label for="modal-form-6">Ukuran</x-base.form-label>
                                <x-base.form-select id="modal-form-6">
                                    <option>M</option>
                                    <option>L</option>
                                    <option>XL</option>
