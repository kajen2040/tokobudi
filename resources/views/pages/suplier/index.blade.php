...
@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium uppercase">Data Suplier</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center xl:flex-nowrap">
            <x-base.button
                ...
                data-tw-target="#tambah-suplier-modal-preview"
            >
                TAMBAH
            </x-base.button>
            ...
            <div class="mt-3 flex w-full items-center xl:mt-0 xl:w-auto">
                <form action="{{ route('suplier.index') }}" method="GET" class="relative w-56 text-slate-500">
                    <x-base.form-input
                            ...
                            <x-base.table.td @class([
                                ...
                                <div class="flex items-center justify-center">
                                    <a
                                        ...
                                        href="#"
                                        data-tw-toggle="modal"
                                        data-tw-target="#edit-suplier-modal"
                                        onclick="openEditModal('{{ route('suplier.update', $suplier->id) }}', '{{ $suplier->nama }}', '{{ $suplier->no_hp }}', '{{ $suplier->alamat }}')"
                                    >
                                        <x-base.lucide
                                            class="mr-1 h-4 w-4"
                                            icon="CheckSquare"
                                    ...
                                    <a
                                        ...
                                        href="#"
                                        onclick="openDeleteModal('{{ route('suplier.destroy', $suplier->id) }}')"
                                    >
                                        <x-base.lucide
                                            class="mr-1 h-4 w-4"
                                            icon="Trash"
    ...
    <!-- BEGIN: Tambah Suplier Modal -->
    <x-base.preview-component class="intro-y">
        <div class="p-5">
            <x-base.preview>
                <!-- BEGIN: Modal Content -->
                <x-base.dialog id="tambah-suplier-modal-preview">
                    <x-base.dialog.panel>
                        <form action="{{ route('suplier.store') }}" method="POST">
                            @csrf
                            <x-base.dialog.title>
                                <h2 class="mr-auto text-base font-medium">
                                    Tambah Suplier Barang
                                </h2>
                            </x-base.dialog.title>
                       
                            <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                                <div class="col-span-12 sm:col-span-12">
                                    <x-base.form-label for="modal-form-1">Suplier Barang</x-base.form-label>
                                    <x-base.form-input
                                        id="modal-form-1"
                                        type="text"
                                        name="nama"
    ...
    <!-- END: Tambah Suplier Modal -->
    
    <!-- BEGIN: Edit Suplier Modal -->
    <x-base.preview-component class="intro-y">
        <div class="p-5">
            <x-base.preview>
                <!-- BEGIN: Modal Content -->
                <x-base.dialog id="edit-suplier-modal">
                    <x-base.dialog.panel>
                        <form id="edit-suplier-form" action="" method="POST">
                            @csrf
                            @method('PUT')
                            <x-base.dialog.title>
                                <h2 class="mr-auto text-base font-medium">
                            ...
                            <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                                <div class="col-span-12 sm:col-span-12">
                                    <x-base.form-label for="edit-nama">Suplier Barang</x-base.form-label>
                                    <x-base.form-input
                                        id="edit-nama"
                                        type="text"
                                        name="nama"
    ...
    <x-base.dialog id="delete-confirmation-modal">
        <x-base.dialog.panel>
            ...
            <div class="px-5 pb-8 text-center">
                <form id="delete-suplier-form" method="POST">
                    @csrf
                    @method('DELETE')
                    <x-base.button
                        class="mr-1 w-24"
...
<script>
    function openEditModal(actionUrl, nama, no_hp, alamat) {
        // Set form action URL
        document.getElementById('edit-suplier-form').action = actionUrl;
    ...
    function openDeleteModal(url) {
        const deleteForm = document.getElementById('delete-suplier-form');
