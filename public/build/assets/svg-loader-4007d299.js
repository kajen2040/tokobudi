(function(){let n=function t(c){return $("[data-loading-icon]").each(function(){let e=$(this).data("color")!==void 0?$(this).data("color"):$("body").css("color"),i=$(this).attr("class")!==void 0?$(this).attr("class"):"",l=[{name:"audio",svg:`
